 ...
 * dimension.
 *
 * FrequencyExpandImageFilter increases the size of an image by an integer
 ...
 * For vector images use VectorFrequencyExpandImageFilter.
 *
 ...
 * \sa VectorFrequencyExpandImageFilter
 *
...
protected:
  ...
  /** FrequencyExpandImageFilter is implemented as a multithreaded filter.  Therefore,
