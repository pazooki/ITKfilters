...
int main(int argc, char** argv){
    ...
    // Compare images: TODO use test facilities instead of region iterators.
   ...
   // TODO remove, already compared
    // Get real part of complex image for visualization(inverse)
    // typename ComplexToRealFilter::Pointer complexToRealFilterInverse = ComplexToRealFilter::New();
    // for (unsigned int i = 0 ; i < high_sub_bands + 1 ; ++i)
    // {
    //     std::cout << "Band: " << i << " / " << inverseFilterBank->GetHighPassSubBands() << std::endl;
    //     std::cout << "Largest Region: " << inverseFilterBank->GetOutput(i)->GetLargestPossibleRegion() << std::endl;
    //
    //     complexToRealFilterInverse->SetInput(inverseFilterBank->GetOutput(i) );
    //     complexToRealFilterInverse->Update();
    //     if(VFLAG) visualize::VisualizeITKImage(complexToRealFilterInverse->GetOutput());
    // }
}
