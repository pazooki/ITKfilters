...
=========================================================================*/
#ifndef itkUnaryFunctorObjectListBooleanFilter_h
#define itkUnaryFunctorObjectListBooleanFilter_h
...
class ITK_EXPORT UnaryFunctorObjectListBooleanFilter :
  public itk::ObjectListToObjectListFilter<TInputList, TOutputList>
{
public:
  /** Standard class typedefs. */
  typedef UnaryFunctorObjectListBooleanFilter                        Self;
  typedef itk::ObjectListToObjectListFilter<TInputList, TOutputList> Superclass;
...
#include "itkUnaryFunctorObjectListBooleanFilter.hxx"
#endif
